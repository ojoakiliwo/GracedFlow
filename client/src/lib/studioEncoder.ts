...
export function windowsGoLiveBat(
  ...
  return [
    ...
    "echo IGC Encoder 3 — Smooth. Keep this window open.",
    ...
    "if not errorlevel 1 (",
    "  echo.",
    "  echo An encoder is already running in another window.",
    "  echo Do not start a second igc-go-live.bat. Close this window.",
    "  echo Use the window that shows frame= numbers counting.",
    "  pause",
    "  exit /b 1",
    ")",
    'set "VIDEO=%~1"',
